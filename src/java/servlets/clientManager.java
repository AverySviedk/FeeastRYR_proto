    ...
    private void signIn(HttpServletRequest request, HttpServletResponse response){
        ...
        try {
            ...
            if (istCount > 0) {
                ...
                response.sendRedirect(request.getContextPath() + "failedProccess?severity=done&msj=Registro%20de%20datos%20sin%20efecto"); // Redirigir a error
            }
        } catch(SQLException sqlex){
            new Connectorizer().logSQLException(context, sqlex);
        } catch (Exception e) {
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                if (idClient.equals("1")) {
                    response.sendRedirect(request.getContextPath() +  "/admin/rentasAdmin.jsp"); // Redirigir a admin
                } else {
