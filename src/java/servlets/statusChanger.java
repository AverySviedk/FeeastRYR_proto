...
public class statusChanger extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        }else if (modo.equals("instCustDir")){   //ELIMINA LA SECION
    ...
    private void insertDirection(HttpServletRequest request, HttpServletResponse response){
        ...
        try {
            ...
            String sql = "INSERT INTO direccion (direccion, ciudad, estado, codigoPostal) VALUES (?, ?, ?, ?)";
            ...
            if (rowsUpdated > 0){//insertItem(request, response);
                setRelClieDir(request, response);
    ...
    private void setRelClieDir(HttpServletRequest request, HttpServletResponse response){
        ServletContext context = request.getServletContext();
        Connection connection = null;
        ...
        try {
            ...
            String sql = "INSERT INTO dir_cliente (idCliente, idDireccion) VALUES (?, ?)";
            PreparedStatement statement = connection.prepareStatement(sql);
            statement.setInt(1, Integer.parseInt(idCliente));
            statement.setInt(2, getLastDirection(request, response));
            int rowsUpdated = statement.executeUpdate();
    ...
    private int getLastDirection(HttpServletRequest request, HttpServletResponse response){
        ServletContext context = request.getServletContext();
        Connection connection = null;
        int res = -1;
        try {
            ...
            if (resultSet.next()){
                ...
                context.log(String.valueOf(res));
                //return res;
            }
        } catch (Exception e) {
            new Connectorizer().logException(context, e);
